...
class Bouquets(Base, Utility):
    ...
    def refresh_channels(self):
        ...
        # TODO: add functionality to refresh and check channels subscribed using the refreshUrl
    ...
    def receive_notification_from_google(self):
        ...
        # TODO: add functionality to receive the google calendar notifications for logging
